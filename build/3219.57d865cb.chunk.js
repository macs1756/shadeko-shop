"use strict";
(self["webpackChunkmy_project"] = self["webpackChunkmy_project"] || []).push([[3219],{
...
const schema = es/* object */.Ry().shape({
  name: es/* string */.Z_(helper_plugin_esm/* translatedErrors */.I0.string).max(100).required(helper_plugin_esm/* translatedErrors */.I0.required),
  type: es/* string */.Z_(helper_plugin_esm/* translatedErrors */.I0.string).oneOf(["read-only", "full-access", "custom"]).required(helper_plugin_esm/* translatedErrors */.I0.required),
  description: es/* string */.Z_().nullable(),
  lifespan: es/* number */.Rx().integer().min(0).nullable().defined(helper_plugin_esm/* translatedErrors */.I0.required)
});
...
const schema = yup_es/* object */.Ry().shape({
  name: yup_es/* string */.Z_(helper_plugin_esm/* translatedErrors */.I0.string).max(100).required(helper_plugin_esm/* translatedErrors */.I0.required),
  description: yup_es/* string */.Z_().nullable(),
  lifespan: yup_es/* number */.Rx().integer().min(0).nullable().defined(helper_plugin_esm/* translatedErrors */.I0.required),
  permissions: yup_es/* string */.Z_(helper_plugin_esm/* translatedErrors */.I0.string).required(helper_plugin_esm/* translatedErrors */.I0.required)
});
/* harmony default export */ const utils_schema = (schema);
...
const TransferTokenCreateView = () => {
  ...
  } = (0,helper_plugin_esm/* useRBAC */.ss)(permissions/* default */.Z.settings["transfer-tokens"]);
  const {
    params: { id }
