...
const schema = es/* object */.Ry().shape({
  autoRegister: es/* bool */.Xg().required(helper_plugin_esm/* translatedErrors */.I0.required),
  ...
  ssoLockedRoles: es/* array */.IX().of(
    es/* mixed */.nK().when("ssoLockedRoles", (value, initSchema) => {
      return value ? initSchema.required(helper_plugin_esm/* translatedErrors */.I0.required) : initSchema.nullable();
    })
  )
});
