...
var Login=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(9442)/* ["default"] */ .Z);}return (__webpack_require__(73347)/* ["default"] */ .Z);}();var forms_forms={'forgot-password':{Component:components_ForgotPassword,endPoint:'forgot-password',fieldsToDisable:[],fieldsToOmit:[],schema:es/* object */.Ry().shape({email:es/* string */.Z_().email(helper_plugin_esm/* translatedErrors */.I0.email).required(helper_plugin_esm/* translatedErrors */.I0.required)}),inputsPrefix:''},'forgot-password-success':{Component:components_ForgotPasswordSuccess,endPoint:'',fieldsToDisable:[],fieldsToOmit:[],schema:null,inputsPrefix:''},login:{Component:Login,endPoint:'login',fieldsToDisable:[],fieldsToOmit:['rememberMe'],schema:es/* object */.Ry().shape({email:es/* string */.Z_().email(helper_plugin_esm/* translatedErrors */.I0.email).required(helper_plugin_esm/* translatedErrors */.I0.required),password:es/* string */.Z_().required(helper_plugin_esm/* translatedErrors */.I0.required),rememberMe:es/* bool */.Xg().nullable()}),inputsPrefix:''},oops:{Component:components_Oops,endPoint:null,fieldsToDisable:[],fieldsToOmit:[],schema:null,inputsPrefix:''},register:{Component:components_Register,endPoint:'register',fieldsToDisable:['email'],fieldsToOmit:['userInfo.confirmPassword','userInfo.news','userInfo.email'],schema:es/* object */.Ry().shape({firstname:es/* string */.Z_().trim().required(helper_plugin_esm/* translatedErrors */.I0.required),lastname:es/* string */.Z_(),password:es/* string */.Z_().min(8,helper_plugin_esm/* translatedErrors */.I0.minLength).matches(/[a-z]/,'components.Input.error.contain.lowercase').matches(/[A-Z]/,'components.Input.error.contain.uppercase').matches(/\d/,'components.Input.error.contain.number').required(helper_plugin_esm/* translatedErrors */.I0.required),confirmPassword:es/* string */.Z_().oneOf([es/* ref */.iH('password'),null],'components.Input.error.password.noMatch').required(helper_plugin_esm/* translatedErrors */.I0.required),registrationToken:es/* string */.Z_().required(helper_plugin_esm/* translatedErrors */.I0.required)}),inputsPrefix:'userInfo.'},'register-admin':{Component:components_Register,endPoint:'register-admin',noSignin:true,fieldsToDisable:[],fieldsToOmit:['confirmPassword','news'],schema:es/* object */.Ry().shape({firstname:es/* string */.Z_().trim().required(helper_plugin_esm/* translatedErrors */.I0.required),lastname:es/* string */.Z_(),password:es/* string */.Z_().min(8,helper_plugin_esm/* translatedErrors */.I0.minLength).matches(/[a-z]/,'components.Input.error.contain.lowercase').matches(/[A-Z]/,'components.Input.error.contain.uppercase').matches(/\d/,'components.Input.error.contain.number').required(helper_plugin_esm/* translatedErrors */.I0.required),email:es/* string */.Z_().email(helper_plugin_esm/* translatedErrors */.I0.email).strict().lowercase(helper_plugin_esm/* translatedErrors */.I0.lowercase).required(helper_plugin_esm/* translatedErrors */.I0.required),confirmPassword:es/* string */.Z_().oneOf([es/* ref */.iH('password'),null],'components.Input.error.password.noMatch').required(helper_plugin_esm/* translatedErrors */.I0.required)}),inputsPrefix:''},'reset-password':{Component:ResetPassword,endPoint:'reset-password',fieldsToDisable:[],fieldsToOmit:['confirmPassword'],schema:es/* object */.Ry().shape({password:es/* string */.Z_().min(8,helper_plugin_esm/* translatedErrors */.I0.minLength).matches(/[a-z]/,'components.Input.error.contain.lowercase').matches(/[A-Z]/,'components.Input.error.contain.uppercase').matches(/\d/,'components.Input.error.contain.number').required(helper_plugin_esm/* translatedErrors */.I0.required),confirmPassword:es/* string */.Z_().oneOf([es/* ref */.iH('password'),null],'components.Input.error.password.noMatch').required(helper_plugin_esm/* translatedErrors */.I0.required)})}};/* harmony default export */ const utils_forms = (forms_forms);
...
var DesignSystemProvider = __webpack_require__(22837);
// EXTERNAL MODULE: ./node_modules/react-intl/lib/src/components/useIntl.js
var useIntl = __webpack_require__(86896);
// EXTERNAL MODULE: ./.cache/admin/src/hooks/index.js + 24 modules
var hooks = __webpack_require__(51319);
// EXTERNAL MODULE: ./node_modules/styled-components/dist/styled-components.browser.esm.js + 4 modules
var styled_components_browser_esm = __webpack_require__(1565);
...
if(!AuthPage_forms[authType]||hasAdmin&&authType==='register-admin'||helper_plugin_esm/* auth */.I8.getToken()){return/*#__PURE__*/react.createElement(react_router/* Redirect */.l_,{to:"/"});}// Redirect the user to the register-admin if it is the first user
...
var constants = __webpack_require__(36657);
...
const AuthenticatedApp = (0,react.lazy)(
  () => Promise.all(/* import() | Admin-authenticatedApp */[__webpack_require__.e(5593), __webpack_require__.e(801)]).then(__webpack_require__.bind(__webpack_require__, 93858))
);
function App() {
  const routes = (0,useEnterprise/* useEnterprise */.c)(
    constants/* ROUTES_CE */.y,
    async () => (await __webpack_require__.e(/* import() */ 9034).then(__webpack_require__.bind(__webpack_require__, 79034))).ROUTES_EE,
    {
      defaultValue: []
    }
  );
...
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(51319);
...
const init_init = (initialState, fieldsToPick) => {
  return { ...initialState, fieldsToPick };
};
/* harmony default export */ const useSettingsForm_init = (init_init);
...
const useSettingsMenu = () => {
  ...
  const { global: globalLinks, admin: adminLinks } = (0,useEnterprise/* useEnterprise */.c)(
    LINKS_CE,
    async () => (await __webpack_require__.e(/* import() */ 2019).then(__webpack_require__.bind(__webpack_require__, 52019))).LINKS_EE,
    {
  ...
  (0,react.useEffect)(() => {
      ...
      const buildMenuPermissions = (sections2) => Promise.all(
        sections2.reduce((acc, section, sectionIndex) => {
          const buildMenuPermissions2 = (links) => links.map(async (link, linkIndex) => ({
            hasPermission: await (0,helper_plugin_esm/* hasPermissions */.qX)(permissions, link.permissions),
            sectionIndex,
            linkIndex
          }));
    ...
    const sections = utils_formatLinks([
      {
        ...settings.global,
        links: utils_sortLinks([...settings.global.links, ...globalLinks]).map((link) => ({
          ...link,
...
function useEnterprise(ceData, eeCallback, { defaultValue = null, combine = (ceData2, eeData) => eeData } = {}) {
...
/* harmony import */ var _components_UnauthenticatedLogo__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(79690);
/* harmony import */ var _layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(35318);
...
/* harmony import */ var _layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(35318);
/* harmony import */ var _BaseLogin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(29773);




const Login = (loginProps) => {
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP, null, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_BaseLogin__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, { ...loginProps }));
};
Login.defaultProps = {
  onSubmit: (e) => e.preventDefault()
};
...
/* harmony export */   Z: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(52176);
...
const useLicenseLimits = () => {
  const rbac = (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_0__/* .useRBAC */ .ss)(_admin_src_permissions__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z.settings.users);
  const {
...
/* harmony import */ var _admin_src_layouts_UnauthenticatedLayout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(35318);
/* harmony import */ var _admin_src_pages_AuthPage_components_Login_BaseLogin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(29773);
