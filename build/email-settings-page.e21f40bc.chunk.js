...
const schema = es/* object */.Ry().shape({
  email: es/* string */.Z_().email(helper_plugin_esm/* translatedErrors */.I0.email).required(helper_plugin_esm/* translatedErrors */.I0.required)
});
...
const ProtectedSettingsPage = () => /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.O4, { permissions: permissions/* default */.Z.settings }, /* @__PURE__ */ react.createElement(SettingsPage, null));
const SettingsPage = () => {
