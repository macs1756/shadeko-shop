(self["webpackChunkmy_project"] = self["webpackChunkmy_project"] || []).push([[4977],{
...
const TableBody = ({ patterns }) => {
  ...
  const handleClickDelete = (id) => {
    (0,helper_plugin_esm/* request */.WY)(`/url-alias/pattern/delete/${id}`, {
      method: "GET"
    }).then((res) => {
  ...
  return /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, statePatterns.map((pattern) => /* @__PURE__ */ react.createElement(Tr.Tr, { key: pattern.label, ...(0,helper_plugin_esm/* onRowClick */.X7)({ fn: () => handleClickEdit(pattern.id) }) }, /* @__PURE__ */ react.createElement(Cell.Td, { width: "20%" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, pattern.label)), /* @__PURE__ */ react.createElement(Cell.Td, { width: "50%" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, null, pattern.pattern)), /* @__PURE__ */ react.createElement(Cell.Td, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "end", ...helper_plugin_esm/* stopPropagation */.UW }, /* @__PURE__ */ react.createElement(
...
const ListPatternPage = () => {
  ...
  (0,react.useEffect)(() => {
    setLoading(true);
    (0,helper_plugin_esm/* request */.WY)(`/url-alias/pattern/findMany`, { method: "GET" }).then((res) => {
      setPatterns(res);
      setLoading(false);
    }).catch(() => {
      setLoading(false);
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
      ...
      as: "h2",
      primaryAction: /* @__PURE__ */ react.createElement(Button/* Button */.z, { onClick: () => push(`/settings/${(pluginId_default())}/patterns/new`), startIcon: /* @__PURE__ */ react.createElement(Plus/* default */.Z, null), size: "L" }, formatMessage({
...
const schema = es/* object */.Ry().shape({
  label: es/* string */.Z_().required(helper_plugin_esm/* translatedErrors */.I0.required),
  pattern: es/* string */.Z_().required(helper_plugin_esm/* translatedErrors */.I0.required),
  contenttype: es/* string */.Z_().required(helper_plugin_esm/* translatedErrors */.I0.required)
...
const SelectComponent = ({
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    list.map((item) => /* @__PURE__ */ react.createElement(Option/* Option */.W, { key: item.uid, value: item.uid }, item.name))
  );
};
/* harmony default export */ const components_Select = (SelectComponent);
...
const LabelField = ({
  ...
  ), generatedCode && !open && /* @__PURE__ */ react.createElement(Box/* Box */.x, { style: { display: "flex", marginTop: 5 } }, hint(generatedCode), /* @__PURE__ */ react.createElement(TextButton/* TextButton */.A, { style: { marginLeft: 5 }, onClick: () => setOpen(true) }, "Edit")), open && /* @__PURE__ */ react.createElement(Box/* Box */.x, { style: { marginTop: 20 } }, /* @__PURE__ */ react.createElement(
    TextInput/* TextInput */.o,
    {
      name: "code",
...
const PatternField = ({ uid, values, error, setFieldValue, hint }) => {
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const HoverBox = (0,styled_components_browser_esm/* default */.ZP)((0,Box/* Box */.x))`
    cursor: pointer;
  ...
  (0,react.useEffect)(() => {
    (0,helper_plugin_esm/* request */.WY)(`/url-alias/pattern/allowed-fields`, { method: "GET" }).then((res) => {
...
const EditPatternPage = () => {
  ...
  const {
    params: { id }
  } = (0,react_router/* useRouteMatch */.$B)(`/settings/${(pluginId_default())}/patterns/:id`);
  (0,react.useEffect)(() => {
    setLoading(true);
    (0,helper_plugin_esm/* request */.WY)(`/url-alias/info/getContentTypes`, { method: "GET" }).then((res) => {
      setContentTypes(res);
      setLoading(false);
    }).catch(() => {
      setLoading(false);
  ...
  (0,react.useEffect)(() => {
    setLoading(true);
    (0,helper_plugin_esm/* request */.WY)(`/url-alias/pattern/findOne/${id}`, { method: "GET" }).then((res) => {
  ...
  const handleEditSubmit = (values, { setSubmitting, setErrors }) => {
    (0,helper_plugin_esm/* request */.WY)(`/url-alias/pattern/update/${patternEntity.id}`, {
      method: "POST",
      body: {
        data: values
      }
  ...
  const validatePattern = async (values) => {
    const errors = {};
    await (0,helper_plugin_esm/* request */.WY)(`/url-alias/pattern/validate`, {
      method: "POST",
      body: {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    ({ handleSubmit, values, handleChange, errors, touched, isSubmitting, setFieldValue }) => /* @__PURE__ */ react.createElement(formik_esm/* Form */.l0, { noValidate: true, onSubmit: handleSubmit }, /* @__PURE__ */ react.createElement(
      HeaderLayout/* HeaderLayout */.T,
      {
        ...
        as: "h2",
        navigationAction: /* @__PURE__ */ react.createElement(Link/* Link */.r, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), to: `/settings/${(pluginId_default())}/patterns` }, formatMessage({
          id: "global.back",
          defaultMessage: "Back"
        })),
        primaryAction: /* @__PURE__ */ react.createElement(Button/* Button */.z, { type: "submit", loading: isSubmitting, startIcon: /* @__PURE__ */ react.createElement(Check/* default */.Z, null) }, formatMessage({
          id: "global.save",
          defaultMessage: "Save"
        }))
      }
      ...
      )), /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: 12 }), /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: 12 }), /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: 6 }, /* @__PURE__ */ react.createElement(
      ...
      )), /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: 12 }), values.contenttype !== "" && /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: 6 }, /* @__PURE__ */ react.createElement(
...
const schema_schema = es/* object */.Ry().shape({
  label: es/* string */.Z_().required(helper_plugin_esm/* translatedErrors */.I0.required),
  pattern: es/* string */.Z_().required(helper_plugin_esm/* translatedErrors */.I0.required),
  contenttype: es/* string */.Z_().required(helper_plugin_esm/* translatedErrors */.I0.required)
  // languages: yup.array().min(1, translatedErrors.required),
...
const CreatePattternPage = () => {
  ...
  const handleCreateSubmit = (values, { setSubmitting, setErrors }) => {
    (0,helper_plugin_esm/* request */.WY)(`/url-alias/pattern/create`, {
      method: "POST",
      body: {
        data: values
      }
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    ({ handleSubmit, values, handleChange, errors, touched, isSubmitting, setFieldValue }) => /* @__PURE__ */ react.createElement(formik_esm/* Form */.l0, { noValidate: true, onSubmit: handleSubmit }, /* @__PURE__ */ react.createElement(
      ...
      )), /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: 12 }), /* @__PURE__ */ react.createElement(GridItem/* GridItem */.P, { col: 6 }, /* @__PURE__ */ react.createElement(
        components_LabelField,
        {
          values,
          setFieldValue,
...
const Patterns = () => {
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.O4, { permissions: permissions/* default */.Z["settings.patterns"] }, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, /* @__PURE__ */ react.createElement(
  ...
  ), /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: `/settings/${(pluginId_default())}/patterns/:id`, component: EditPage, exact: true }), /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: `/settings/${(pluginId_default())}/patterns`, component: ListPage, exact: true }), /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: "", component: helper_plugin_esm.NotFound })));
};
