...
const schema = es/* object */.Ry().shape({
  name: es/* string */.Z_().required(helper_plugin_esm/* translatedErrors */.I0.required),
  description: es/* string */.Z_().required(helper_plugin_esm/* translatedErrors */.I0.required)
});
...
/* harmony default export */ function Roles_CreatePage() {
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.O4, { permissions: permissions/* default */.Z.settings.roles.create }, /* @__PURE__ */ react.createElement(CreatePage, null));
}
