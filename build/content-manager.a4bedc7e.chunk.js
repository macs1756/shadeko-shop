...
var selectors = __webpack_require__(84668);
...
var Briefcase = __webpack_require__(16912);
// EXTERNAL MODULE: ./node_modules/@strapi/icons/dist/Brush.js
var Brush = __webpack_require__(9705);
...
var Cloud = __webpack_require__(45491);
...
var Landscape = __webpack_require__(56821);
...
var dist_Layout = __webpack_require__(33911);
// EXTERNAL MODULE: ./node_modules/@strapi/icons/dist/Lightbulb.js
var Lightbulb = __webpack_require__(33632);
...
var Magic = __webpack_require__(78009);
...
var Medium = __webpack_require__(25870);
...
var Paint = __webpack_require__(94726);
// EXTERNAL MODULE: ./node_modules/@strapi/icons/dist/PaintBrush.js
var PaintBrush = __webpack_require__(36347);
...
var Phone = __webpack_require__(20711);
...
var PriceTag = __webpack_require__(64529);
...
var Typhoon = __webpack_require__(57785);
...
const ModalForm = ({ onMetaChange, onSizeChange }) => {
  ...
  const schemasSelector = (0,react.useMemo)(selectors/* makeSelectModelAndComponentSchemas */.Vo, []);
  const { schemas } = (0,react_redux_es/* useSelector */.v9)((state) => schemasSelector(state), react_redux_es/* shallowEqual */.wU);
  const fieldSizes = (0,react_redux_es/* useSelector */.v9)(selectors/* selectFieldSizes */.Jg);
...
const CollectionTypeFormWrapper = ({ allLayoutData, children, slug, id, origin }) => {
  ...
  const { componentsDataStructure, contentTypeDataStructure, data, isLoading, status } = (0,react_redux_es/* useSelector */.v9)(crudReducer_selectors);
...
// EXTERNAL MODULE: ./node_modules/@strapi/design-system/dist/v2/SimpleMenu/Menu.js + 15 modules
var Menu = __webpack_require__(2941);
// EXTERNAL MODULE: ./node_modules/@strapi/design-system/dist/v2/SimpleMenu/SimpleMenu.js
var SimpleMenu_SimpleMenu = __webpack_require__(40714);
...
const useRelation = (cacheKey, { relation, search }) => {
  ...
  const relationsRes = (0,es.useInfiniteQuery)(["relation", ...cacheKey], fetchRelations, {
    cacheTime: 0,
  ...
  const searchRes = (0,es.useInfiniteQuery)(
...
Relation_Relation.defaultProps = {
  search: void 0,
  loadMore: void 0,
  totalNumberOfRelations: 0
};
Relation_Relation.propTypes = {
  children: (prop_types_default()).node.isRequired,
...
const BoxWithBorder = (0,styled_components_browser_esm/* default */.ZP)((0,Box/* Box */.x))`
  border-right: 1px solid ${({ theme }) => theme.colors.neutral200};
`;
const EditorLayout_ExpandButton = (0,styled_components_browser_esm/* default */.ZP)((0,BaseButton/* BaseButton */.Y))`
  background-color: transparent;
  border: none;
  align-items: center;
...
var Popover = __webpack_require__(37108);
...
const WysiwygNav = ({
  ...
  if (disabled || isPreviewMode) {
    return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { padding: 2, background: "neutral100", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(StyledFlex, null, /* @__PURE__ */ react.createElement(Select/* Select */.P, { disabled: true, placeholder: selectPlaceholder, size: "S", label: selectPlaceholder }, /* @__PURE__ */ react.createElement(Option/* Option */.W, { value: "h1" }, "h1"), /* @__PURE__ */ react.createElement(Option/* Option */.W, { value: "h2" }, "h2"), /* @__PURE__ */ react.createElement(Option/* Option */.W, { value: "h3" }, "h3"), /* @__PURE__ */ react.createElement(Option/* Option */.W, { value: "h4" }, "h4"), /* @__PURE__ */ react.createElement(Option/* Option */.W, { value: "h5" }, "h5"), /* @__PURE__ */ react.createElement(Option/* Option */.W, { value: "h6" }, "h6")), /* @__PURE__ */ react.createElement(MainButtons, null, /* @__PURE__ */ react.createElement(WysiwygStyles_CustomIconButton, { disabled: true, id: "Bold", label: "Bold", name: "Bold", icon: /* @__PURE__ */ react.createElement(Bold/* default */.Z, null) }), /* @__PURE__ */ react.createElement(WysiwygStyles_CustomIconButton, { disabled: true, id: "Italic", label: "Italic", name: "Italic", icon: /* @__PURE__ */ react.createElement(Italic/* default */.Z, null) }), /* @__PURE__ */ react.createElement(
...
const DynamicComponent = ({
  ...
  const accordionActions = !isFieldAllowed ? null : /* @__PURE__ */ react.createElement(DynamicComponent_ActionsFlex, { gap: 0, expanded: isOpen }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Drag/* default */.Z, null)
  ), /* @__PURE__ */ react.createElement(Menu/* Root */.fC, null, /* @__PURE__ */ react.createElement(Menu/* Trigger */.xz, { size: "S", endIcon: void 0, paddingLeft: 2, paddingRight: 2 }, /* @__PURE__ */ react.createElement(More/* default */.Z, { "aria-hidden": true, focusable: false }), /* @__PURE__ */ react.createElement(VisuallyHidden/* VisuallyHidden */.T, { as: "span" }, formatMessage({
    ...
    SimpleMenu_SimpleMenu/* MenuItem */.sN,
    {
      key: componentUid2,
...
const EditViewDataManagerProvider = ({
  ...
  const { setModifiedDataOnly } = (0,react_redux_es/* useSelector */.v9)(crudReducer_selectors);
  const reduxDispatch = (0,react_redux_es/* useDispatch */.I0)();
  const toggleNotification = (0,helper_plugin_esm/* useNotification */.lm)();
  ...
  return /* @__PURE__ */ react.createElement(
    helper_plugin_esm/* ContentManagerEditViewDataManagerContext */.W1.Provider,
    {
      value: {
        addComponentToDynamicZone,
        addNonRepeatableComponentToField,
    ...
    isLoadingForData || !isCreatingEntry && !initialData.id ? /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": "true" }, /* @__PURE__ */ react.createElement(helper_plugin_esm/* LoadingIndicatorPage */.dO, null)) : /* @__PURE__ */ react.createElement(react.Fragment, null, !isSaving ? /* @__PURE__ */ react.createElement(
...
var EditViewLayoutManager_selectors = __webpack_require__(21323);
...
const EditViewLayoutManager = ({ layout, ...rest }) => {
  const currentLayout = (0,react_redux_es/* useSelector */.v9)(EditViewLayoutManager_selectors/* default */.Z);
  const dispatch = (0,react_redux_es/* useDispatch */.I0)();
...
const SortDisplayedFields_FlexWrapper = (0,styled_components_browser_esm/* default */.ZP)((0,Box/* Box */.x))`
  flex: ${({ size }) => size};
`;
...
;// CONCATENATED MODULE: ./.cache/admin/src/content-manager/components/DynamicTable/BulkActionsBar/index.js
...
const BulkActionsBar = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { trackUsage } = (0,helper_plugin_esm/* useTracking */.rS)();
  const { data } = (0,react_redux_es/* useSelector */.v9)(listViewDomain());
  const [isConfirmButtonLoading, setIsConfirmButtonLoading] = (0,react.useState)(false);
  const [dialogToOpen, setDialogToOpen] = (0,react.useState)(null);
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, publishButtonIsShown && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Button/* Button */.z, { variant: "tertiary", onClick: togglePublishModal }, formatMessage({ id: "app.utils.publish", defaultMessage: "Publish" })), /* @__PURE__ */ react.createElement(
  ...
  )), unpublishButtonIsShown && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Button/* Button */.z, { variant: "tertiary", onClick: toggleUnpublishModal }, formatMessage({ id: "app.utils.unpublish", defaultMessage: "Unpublish" })), /* @__PURE__ */ react.createElement(
  ...
  )), showDelete && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Button/* Button */.z, { variant: "danger-light", onClick: toggleDeleteModal }, formatMessage({ id: "global.delete", defaultMessage: "Delete" })), /* @__PURE__ */ react.createElement(
...
BulkActionsBar.propTypes = {
  ...
  onConfirmPublishAll: (prop_types_default()).func,
  onConfirmUnpublishAll: (prop_types_default()).func,
  selectedEntries: (prop_types_default()).array.isRequired,
  clearSelectedEntries: (prop_types_default()).func.isRequired
};
/* harmony default export */ const DynamicTable_BulkActionsBar = (BulkActionsBar);
...
const RelationMultiple = ({ fieldSchema, metadatas, name, entityId, value, contentType }) => {
  ...
  const { data, status } = (0,es.useQuery)(
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { ...helper_plugin_esm/* stopPropagation */.UW }, /* @__PURE__ */ react.createElement(
    ...
    status === "success" && /* @__PURE__ */ react.createElement(react.Fragment, null, data?.results.map((entry) => /* @__PURE__ */ react.createElement(SimpleMenu/* MenuItem */.s, { key: entry.id, "aria-disabled": true }, /* @__PURE__ */ react.createElement(RelationMultiple_TypographyMaxWidth, { ellipsis: true }, /* @__PURE__ */ react.createElement(
...
var reviewWorkflowColumn=getReviewWorkflowsColumn(layout);if(reviewWorkflowColumn){formattedHeaders.push(reviewWorkflowColumn);}return formattedHeaders;},[runHookWaterfall,displayedHeaders,layout,hasDraftAndPublish,formatMessage]);return/*#__PURE__*/react.createElement(helper_plugin_esm/* DynamicTable */.tM,{components:{ConfirmDialogDelete:DynamicTable_ConfirmDialogDelete},contentType:contentTypeName,action:action,isLoading:isLoading,headers:tableHeaders,onConfirmDelete:onConfirmDelete,onOpenDeleteAllModalTrackedEvent:"willBulkDeleteEntries",rows:rows,withBulkActions:true,withMainAction:(canDelete||canPublish)&&isBulkable,renderBulkActionsBar:function renderBulkActionsBar(_ref3){var selectedEntries=_ref3.selectedEntries,clearSelectedEntries=_ref3.clearSelectedEntries;return/*#__PURE__*/react.createElement(DynamicTable_BulkActionsBar,{showPublish:canPublish&&hasDraftAndPublish,showDelete:canDelete,onConfirmDeleteAll:onConfirmDeleteAll,onConfirmPublishAll:onConfirmPublishAll,onConfirmUnpublishAll:onConfirmUnpublishAll,selectedEntries:selectedEntries,clearSelectedEntries:clearSelectedEntries});}},/*#__PURE__*/react.createElement(DynamicTable_TableRows,{canCreate:canCreate,canDelete:canDelete,contentType:layout.contentType,headers:tableHeaders,rows:rows,withBulkActions:true,withMainAction:canDelete&&isBulkable}));};DynamicTable.defaultProps={action:undefined};DynamicTable.propTypes={canCreate:(prop_types_default()).bool.isRequired,canDelete:(prop_types_default()).bool.isRequired,canPublish:(prop_types_default()).bool.isRequired,contentTypeName:(prop_types_default()).string.isRequired,action:(prop_types_default()).node,isBulkable:(prop_types_default()).bool.isRequired,isLoading:(prop_types_default()).bool.isRequired,layout:prop_types_default().exact({components:(prop_types_default()).object.isRequired,contentType:prop_types_default().shape({attributes:(prop_types_default()).object.isRequired,metadatas:(prop_types_default()).object.isRequired,layouts:prop_types_default().shape({list:(prop_types_default()).array.isRequired}).isRequired,options:(prop_types_default()).object.isRequired,settings:(prop_types_default()).object.isRequired}).isRequired}).isRequired,onConfirmDelete:(prop_types_default()).func.isRequired,onConfirmDeleteAll:(prop_types_default()).func.isRequired,onConfirmPublishAll:(prop_types_default()).func.isRequired,onConfirmUnpublishAll:(prop_types_default()).func.isRequired,rows:(prop_types_default()).array.isRequired};/* harmony default export */ const components_DynamicTable = (DynamicTable);
...
const FieldPicker = ({ layout }) => {
  const dispatch = (0,react_redux_es/* useDispatch */.I0)();
  const displayedHeaders = (0,react_redux_es/* useSelector */.v9)(selectDisplayedHeaders);
  const { trackUsage } = (0,helper_plugin_esm/* useTracking */.rS)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
...
const ConfigureLayoutBox = (0,styled_components_browser_esm/* default */.ZP)((0,Box/* Box */.x))`
  svg {
    path {
...
function ListView({
  ...
  const bulkPublishMutation = (0,es.useMutation)(
    (data2) => post(`/content-manager/collection-types/${contentType.uid}/actions/bulkPublish`, data2),
    {
      onSuccess() {
        toggleNotification({
          type: "success",
  ...
  const bulkUnpublishMutation = (0,es.useMutation)(
  ...
  const validateEntriesToPublish = async (selectedEntries) => {
    ...
    const validationPromises = entries.map(
      (entry) => schema.validate(entry, { abortEarly: false })
    );
    const resolvedPromises = await Promise.allSettled(validationPromises);
    resolvedPromises.forEach((promise) => {
      if (promise.status === "rejected") {
        const entityId = promise.reason.value.id;
        validations.errors[entityId] = (0,helper_plugin_esm/* getYupInnerErrors */.CJ)(promise.reason);
      }
    ...
    if (Object.values(validations.errors).length) {
      toggleNotification({
        ...
        message: {
          ...
          defaultMessage: "Please make sure all fields are valid before publishing (required field, min/max character limit, etc.)"
        }
      });
...
const withConnect = (0,react_redux_es/* connect */.$j)(mapStateToProps, mapDispatchToProps);
...
const LeftMenu = () => {
  ...
  const modelLinksSelector = (0,react.useMemo)(selectors/* makeSelectModelLinks */.KQ, []);
  const { collectionTypeLinks, singleTypeLinks } = (0,react_redux_es/* useSelector */.v9)(modelLinksSelector, react_redux_es/* shallowEqual */.wU);
...
const useContentManagerInitData = () => {
  const dispatch = (0,react_redux_es/* useDispatch */.I0)();
  const toggleNotification = (0,helper_plugin_esm/* useNotification */.lm)();
  const state = (0,react_redux_es/* useSelector */.v9)((0,selectors/* selectAppDomain */.Yg)());
...
// EXTERNAL MODULE: ./.cache/admin/src/content-manager/utils/index.js + 12 modules
var content_manager_utils = __webpack_require__(13920);
...
const Title = () => {
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 2 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "sigma", textColor: "neutral600", id: "additional-information" }, formatMessage({
    id: (0,content_manager_utils/* getTrad */.OB)("containers.Edit.information"),
...
const Body = () => {
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 2, as: "dl" }, /* @__PURE__ */ react.createElement(
    ...
    {
      label: formatMessage({
        id: (0,content_manager_utils/* getTrad */.OB)("containers.Edit.information.created"),
    ...
    {
      label: formatMessage({
        id: (0,content_manager_utils/* getTrad */.OB)("containers.Edit.information.by"),
        defaultMessage: "By"
      }),
      value: created.by
    }
    ...
    {
      label: formatMessage({
        id: (0,content_manager_utils/* getTrad */.OB)("containers.Edit.information.lastUpdate"),
...
function InformationBoxEE() {
  ...
  return /* @__PURE__ */ react.createElement(Information/* default */.Z.Root, null, /* @__PURE__ */ react.createElement(Information/* default */.Z.Title, null), hasReviewWorkflowsEnabled && !isCreatingEntry && /* @__PURE__ */ react.createElement(
  ...
  ), /* @__PURE__ */ react.createElement(Information/* default */.Z.Body, null));
}
