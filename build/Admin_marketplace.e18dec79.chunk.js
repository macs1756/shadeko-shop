...
const InstallPluginButton = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { trackUsage } = (0,helper_plugin_esm/* useTracking */.rS)();
  const { copy } = (0,helper_plugin_esm/* useClipboard */.VP)();
...
const PackageStats = ({ githubStars, npmDownloads, npmPackageType }) => {
  const { formatMessage } = (0,useIntl/* default */.Z)();
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 1 }, !!githubStars && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { as: Github/* default */.Z, height: (0,helper_plugin_esm/* pxToRem */.Q1)(12), width: (0,helper_plugin_esm/* pxToRem */.Q1)(12), "aria-hidden": true }), /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { as: Star/* default */.Z, height: (0,helper_plugin_esm/* pxToRem */.Q1)(12), width: (0,helper_plugin_esm/* pxToRem */.Q1)(12), color: "warning500", "aria-hidden": true }), /* @__PURE__ */ react.createElement(
    "p",
    {
...
const ProtectedMarketPlace = () => /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.O4, { permissions: permissions/* default */.Z.marketplace.main }, /* @__PURE__ */ react.createElement(MarketPlacePage, null));
