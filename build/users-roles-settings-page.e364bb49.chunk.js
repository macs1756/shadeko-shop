...
const usePlugins = () => {
  ...
  const [
    ...
    {
      queryKey: [src_pluginId/* default */.Z, "permissions"],
      async queryFn() {
        const res = await get(`/${src_pluginId/* default */.Z}/permissions`);
        return res.data.permissions;
      }
    },
    {
      queryKey: [src_pluginId/* default */.Z, "routes"],
      async queryFn() {
        const res = await get(`/${src_pluginId/* default */.Z}/routes`);
...
const ProtectedRolesCreatePage = () => /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.O4, { permissions: permissions/* default */.Z.createRole }, /* @__PURE__ */ react.createElement(Roles_CreatePage, null));
...
const ProtectedRolesEditPage = () => /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.O4, { permissions: permissions/* default */.Z.updateRole }, /* @__PURE__ */ react.createElement(Roles_EditPage, null));
...
const RoleListPage = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(helper_plugin_esm/* SettingsPageTitle */.SL, { name: pageTitle }), /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
      ...
      primaryAction: /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPermissions */.jW, { permissions: permissions/* default */.Z.createRole }, /* @__PURE__ */ react.createElement(Button/* Button */.z, { onClick: handleNewRoleClick, startIcon: /* @__PURE__ */ react.createElement(Plus/* default */.Z, null), size: "S" }, formatMessage({
...
const ProtectedRolesListPage = () => {
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.O4, { permissions: permissions/* default */.Z.accessRoles }, /* @__PURE__ */ react.createElement(ListPage, null));
};
...
const Roles = () => {
  return /* @__PURE__ */ react.createElement(helper_plugin_esm/* CheckPagePermissions */.O4, { permissions: permissions/* default */.Z.accessRoles }, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, /* @__PURE__ */ react.createElement(
